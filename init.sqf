...
// cruise control
[] execVM "\life_server\fxe\mod_cruiseControl.sqf";
//Map Additions
if (isServer) then {
	call compile preProcessFileLineNumbers "\life_server\map\bank.sqf";
	call compile preProcessFileLineNumbers "\life_server\map\emt_sofia.sqf";
	call compile preProcessFileLineNumbers "\life_server\map\grenzverlauf.sqf";
